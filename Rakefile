...
task :prerelease do
  announce 
  announce "**************************************************************"
  announce "* Making RubyRi Release #{PKG_VERSION}"
...
task :update_version => [:prerelease] do
  if PKG_VERSION == CURRENT_VERSION
    ...
    announce "Updating RubyRi version to #{PKG_VERSION}"
    open("lib/rubyri/rubyri_version.rb", "w") do |f|
      f.puts "# DO NOT EDIT"
      f.puts "# This file is auto-generated by build scripts."
      f.puts "# See:  rake update_version"
      f.puts "module RubyRi"
      f.puts "  RubyRiVersion = '#{PKG_VERSION}'"
      f.puts "end"
    end
    if ENV['RELTEST']
      announce "Release Task Testing, skipping commiting of new version"
    else
      sh %{svn commit -m "Updated to version #{PKG_VERSION}" lib/rubyri/rubyri_version.rb}
    end
  end
end
...
task :publish_rdoc => ["html/index.html"] do
  ...
  mkdir_p "emptydir"
  sh "scp -rq emptydir rubyforge:/var/www/gforge-projects/rubyri/rdoc"
  sh "scp -rq html/* rubyforge:/var/www/gforge-projects/rubyri/rdoc"
  rm_r "emptydir"
end
